<footer class="py-12 px-4">
    <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between text-sm text-gray-500">
        <div class="flex items-center space-x-4">
            ...
            <a href="https://umami.iqfareez.com/share/FAEMGDGEluEVwDNa" class="hover:underline">Analytics</a>
        </div>
